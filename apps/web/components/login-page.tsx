...
export default function LoginPage({ onLogin }: LoginPageProps) {
  const [methods, setMethods] = useState<AuthMethods>({ local: true, demo: false, oidc: false, google: false, github: false });
    ...
    <div style={{ minHeight: "100vh", background: "#080808", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "monospace" }}>
      <div style={{ width: 360, background: "#0a0a0a", border: "1px solid #1a1a1a", borderRadius: 8, padding: "32px 28px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 11, color: "#555", marginTop: 4 }}>Software Intelligence Platform</div>
        </div>
        ...
        {/* Divider */}
        {methods.local && (methods.oidc || methods.google || methods.github || methods.demo) && (
