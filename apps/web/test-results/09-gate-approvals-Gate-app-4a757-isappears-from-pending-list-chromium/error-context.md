...
- Name: 09-gate-approvals.spec.ts >> Gate approvals — full lifecycle >> P1: UI — click Approve button, gate disappears from pending list
- Location: e2e/09-gate-approvals.spec.ts:122:7
